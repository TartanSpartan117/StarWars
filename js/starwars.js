...
Author: Rob Uhrig
Created 28-Jun-2022
This is the JavaScript for our Star Wars web page
*/
  ...
  buildNav: () => {
    ...
    for (let nm in APP.urls) {
      if (nm != "base") {
        ...
        link.textContent = nm;
        link.setAttribute("data-link", `${APP.urls.base}${APP.urls}`);
        df.append(link);
      }
    }
...
//const catListURL = "";
//const cat-list = document.getElementById("");
//const specific-list = "";
...
//Fill second combo box with list of subcategories from API

//On click fill the info panel
